...
*/
    ...
    private static FogDevice addGw(String id, int userId, String appId, int parentId) {
        FogDevice dept = createFogDevice("d-" + id, 2800, 4000, 10000, 10000, 1, 0.0, 107.339, 83.4333, 4.5);
        fogDevices.add(dept);
    ...
    private static FogDevice addMobile(String id, int userId, String appId, int parentId) {
        FogDevice mobile = createFogDevice("m-" + id, 1000, 1000, 10000, 270, 3, 0, 87.53, 82.44, 4.5);
    ...
    private static FogDevice createFogDevice(String nodeName, long mips,
        ...
        PowerHost host = new PowerHost(
                ...
                new FogLinearWithSnapPowerModel(busyPower, idlePower, sleepPower)
        );
